...
const PartnerPortal = () => {
  ...
  const subTabs = [
    ...
    { name: "Empolye and branches", path: "/partners/empolye" },
    { name: "Portal Partner", path: "/partners/portal" },
  ];
        ...
        <div className="col-12 col-lg-10">
          <div className="container">
            ...
            <div className="px-3 px-lg-4 my-3">
              ...
              <PartnersTabs activeName="Portal" />

              {/* Secondary Navigation - Portal specific tabs */}
                  ...
                  <nav className="nav flex-wrap gap-2">
                    {subTabs.map((tab, index) => (
                      <NavLink
                        ...
                        to={tab.path}
                        className={({ isActive }) =>
                          `nav-link btn btn-link text-decoration-none px-0 me-3 border-0 ${
                            isActive
