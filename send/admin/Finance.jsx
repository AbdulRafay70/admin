...
const FinanceDashboard = () => {
  const stats = [
    ...
    },
    {
      ...
      value: "Rs. 0",
      change: "0%",
      icon: <PieChart className="text-warning" size={24} />,
      bgColor: "#fff3cd",
    },
  ];
    ...
    <div>
      ...
      <Row className="g-3 mb-4">
        {stats.map((stat, index) => (
          <Col key={index} md={6} lg={3} sm={6} xs={12}>
        ...
        <Card.Body>
          ...
          <Table responsive hover className="finance-table">
            ...
            <tbody>
              <tr>
                <td>Hotels</td>
                <td className="text-success">Rs. 5,000,000</td>
                <td className="text-danger">Rs. 3,000,000</td>
                <td className="fw-bold text-primary">Rs. 2,000,000</td>
                <td><span className="badge bg-success">Profit</span></td>
              </tr>
              <tr>
                <td>Visas</td>
                <td className="text-success">Rs. 2,000,000</td>
                <td className="text-danger">Rs. 1,600,000</td>
                <td className="fw-bold text-primary">Rs. 400,000</td>
                <td><span className="badge bg-success">Profit</span></td>
              </tr>
              <tr>
                <td>Transport</td>
                <td className="text-success">Rs. 1,000,000</td>
                <td className="text-danger">Rs. 700,000</td>
                <td className="fw-bold text-primary">Rs. 300,000</td>
                <td><span className="badge bg-success">Profit</span></td>
              </tr>
              <tr>
                <td>Tickets</td>
                <td className="text-success">Rs. 4,400,000</td>
                <td className="text-danger">Rs. 3,400,000</td>
                <td className="fw-bold text-primary">Rs. 1,000,000</td>
                <td><span className="badge bg-success">Profit</span></td>
              </tr>
            </tbody>
          </Table>
