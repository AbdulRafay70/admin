...
const UniversalRegister = () => {
  ...
  const loadParentOptions = async () => {
    ...
    try {
      ...
      if (formData.type === "branch") {
        endpoint = "/universal/list?type=organization";
      } else if (formData.type === "agent") {
        endpoint = "/universal/list?type=branch";
      } else if (formData.type === "employee") {
        // Can be org or branch - load both
        endpoint = "/universal/list?type=organization,branch";
      }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // TODO: Replace with actual API call
      // const response = await fetch("/universal/register", {
      //   method: "POST",
      //   body: submitData
      // });
      ...
      showAlert("success", `${formData.type.charAt(0).toUpperCase() + formData.type.slice(1)} registered successfully!`);
