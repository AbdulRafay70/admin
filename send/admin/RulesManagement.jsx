  ...
  const demoRules = [
    {
      ...
      description: "All Umrah bookings are subject to advance payment and visa approval. Cancellation charges apply as per the package policy.",
      rule_type: "terms_and_conditions",
    ...
    },
    {
      ...
      description: "Cancellation within 24 hours of check-in is non-refundable. For cancellations made 48 hours prior, 50% refund will be processed.",
    ...
    {
      id: 3,
      title: "Agent Commission Rules",
      description: "Agent commissions are calculated at 5% for regular packages and 7% for premium packages. Payments are processed monthly.",
    ...
    {
      id: 4,
      title: "Transport Pickup Policy",
      description: "Passengers must be ready 15 minutes before scheduled pickup time. Delays beyond 30 minutes may result in service cancellation.",
    ...
    {
      id: 5,
      title: "Visa Document Requirements",
      description: "Original passport with 6 months validity, 2 passport-size photos, polio certificate, and meningitis vaccination certificate are mandatory.",
    ...
    {
      id: 6,
      title: "Payment Terms - Urdu",
      description: "تمام بکنگز کے لیے پیشگی ادائیگی ضروری ہے۔ ویزا کی منظوری کے بعد باقی رقم ادا کی جائے گی۔",
      rule_type: "terms_and_conditions",
    ...
    {
      id: 7,
      title: "Refund Policy (Inactive)",
      description: "Refunds are processed within 14 working days. Bank charges may apply.",
